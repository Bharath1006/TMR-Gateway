...
import com.bharath.TMR_Service.model.Movie;
import com.bharath.TMR_Service.model.MovieRating;
    ...
    public ResponseEntity<Object> fetchMovieAndRating(@PathVariable Long id) {
        ...
        try {
            ...
            if (ex.getStatusCode() == HttpStatus.NOT_FOUND) {
                rating = new Rating(movie.getId().intValue(), movie.getName(), 0.0, 0);
            } else {
                rating = new Rating(movie.getId().intValue(), movie.getName(), -1.0, -1);
            }
